...
class AndroidPreferencesManager(context: Context) : PreferencesManager {
    ...
    override var isSmsReadingEnabled: Boolean
    ...
    override var defaultBudgetId: Int
    ...
    override var selectedBankIds: Set<String>
        get() {
    ...
    override var isAiProcessingEnabled: Boolean

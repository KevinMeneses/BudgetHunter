...
class PreferencesManager(context: Context) {
    ...
    var selectedBankId: String? // Nullable si ninguno está seleccionado
        get() = sharedPreferences.getString(KEY_SELECTED_BANK_ID, null)
        set(value) = sharedPreferences.edit { putString(KEY_SELECTED_BANK_ID, value) }
    ...
    companion object {
        ...
        private const val KEY_SELECTED_BANK_ID = "selected_bank_id"
    }
}
